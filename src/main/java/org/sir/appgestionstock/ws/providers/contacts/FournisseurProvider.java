...
public ResponseEntity<Pagination<FournisseurDto>> findPaginated(
...
@PostMapping("/all")
public ResponseEntity<List<FournisseurDto>> save(@RequestBody List<FournisseurDto> dtos) {
...
@PutMapping("/all")
public ResponseEntity<List<FournisseurDto>> update(@RequestBody List<FournisseurDto> dtos) {
if (dtos == null) return ResponseEntity.status(HttpStatus.CONFLICT).build();
var item = converter.toItem(dtos);
var result = service.update(item);
var resultDto = converter.toDto(result);
...
@DeleteMapping
public ResponseEntity<FournisseurDto> delete(@RequestBody FournisseurDto dto) {
if (dto == null) return ResponseEntity.status(HttpStatus.CONFLICT).build();
var item = converter.toItem(dto);
service.delete(item);
...
@DeleteMapping("/all")
public ResponseEntity<List<FournisseurDto>> delete(@RequestBody List<FournisseurDto> dtos) {
if (dtos == null) return ResponseEntity.status(HttpStatus.CONFLICT).build();
var item = converter.toItem(dtos);
service.delete(item);
...
public ResponseEntity<FournisseurDto> findByAdresseId(@PathVariable Long id){
...
public ResponseEntity<List<FournisseurDto>> findByDevisesId(@PathVariable Long id){
...
public ResponseEntity<List<FournisseurDto>> findByNiveauPrixId(@PathVariable Long id){
...
public ResponseEntity<List<FournisseurDto>> findByTaxeId(@PathVariable Long id){
...
public ResponseEntity<List<FournisseurDto>> findByEntrepriseId(@PathVariable Long id){
