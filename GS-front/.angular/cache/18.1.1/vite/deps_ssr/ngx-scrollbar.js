...
var _SmoothScrollManager = class _SmoothScrollManager {
  ...
  _initSmoothScroll(el) {
    ...
    return this._onGoingScrolls.set(el, new import_rxjs.Subject()).get(el);
  }
  /**
  ...
  _interrupted(el, destroyed) {
    return (0, import_rxjs.merge)((0, import_rxjs.fromEvent)(el, "wheel", {
      passive: true,
      capture: true
    }), (0, import_rxjs.fromEvent)(el, "touchmove", {
      passive: true,
      capture: true
    }), destroyed).pipe((0, import_rxjs.take)(1));
  }
  /**
  ...
  _step(context) {
    return new import_rxjs.Observable((subscriber) => {
      ...
      import_rxjs.animationFrameScheduler.schedule(() => subscriber.next(context));
    });
  }
  _applyScrollToOptions(el, options) {
    ...
    return new Promise((resolve) => {
      (0, import_rxjs.of)(null).pipe((0, import_rxjs.expand)(() => this._step(context).pipe((0, import_rxjs.takeWhile)((currContext) => this._isFinished(currContext, destroyed, resolve)))), (0, import_rxjs.takeUntil)(this._interrupted(el, destroyed)), (0, import_rxjs.finalize)(() => this._destroy(el, destroyed))).subscribe();
    });
  }
  /**
...
function stopPropagation() {
  return (0, import_rxjs2.tap)((e) => e.stopPropagation());
}
...
var _ScrollViewport = class _ScrollViewport {
  ...
  activatePointerEvents(propagate, destroyed) {
    this.hovered = new import_rxjs2.Observable((subscriber) => {
      const mouseMoveStream = (0, import_rxjs2.fromEvent)(this.nativeElement, "mousemove", {
        passive: true
      });
      const mouseMove = propagate ? mouseMoveStream : mouseMoveStream.pipe(stopPropagation());
      const mouseLeave = (0, import_rxjs2.fromEvent)(this.nativeElement, "mouseleave", {
        passive: true
      }).pipe((0, import_rxjs2.map)(() => false));
      (0, import_rxjs2.merge)(mouseMove, mouseLeave).pipe((0, import_rxjs2.tap)((e) => subscriber.next(e)), (0, import_rxjs2.takeUntil)(destroyed)).subscribe();
    });
    this.clicked = new import_rxjs2.Observable((subscriber) => {
      const mouseDown = (0, import_rxjs2.fromEvent)(this.nativeElement, "mousedown", {
        passive: true
      }).pipe((0, import_rxjs2.tap)((e) => subscriber.next(e)));
      const mouseUp = (0, import_rxjs2.fromEvent)(this.nativeElement, "mouseup", {
        passive: true
      }).pipe((0, import_rxjs2.tap)(() => subscriber.next(false)));
      mouseDown.pipe((0, import_rxjs2.switchMap)(() => mouseUp), (0, import_rxjs2.takeUntil)(destroyed)).subscribe();
    });
  }
  /**
...
var _TrackAdapter = class _TrackAdapter {
  ...
  get clicked() {
    const mouseDown = (0, import_rxjs2.fromEvent)(this.trackElement, "mousedown", {
      passive: true
    }).pipe(stopPropagation(), preventSelection(this.document));
    const mouseup = (0, import_rxjs2.fromEvent)(this.document, "mouseup", {
      passive: true
    }).pipe(stopPropagation(), enableSelection(this.document), (0, import_rxjs2.switchMap)(() => import_rxjs2.EMPTY));
    return (0, import_rxjs2.merge)(mouseDown, mouseup);
  }
  ...
  onTrackClicked(e, thumbSize, scrollSize) {
    return (0, import_rxjs2.of)(e).pipe(
      (0, import_rxjs2.map)((e2) => e2[this.pageProperty]),
      // Calculate scrollTo position
      (0, import_rxjs2.map)((pageOffset) => {
...
var _ThumbAdapter = class _ThumbAdapter {
  ...
  get clicked() {
    return (0, import_rxjs2.fromEvent)(this.thumbElement, "mousedown", {
      passive: true
  ...
  constructor(cmp, track, thumbElement, document) {
    ...
    this.document = document;
    this._dragging = new import_rxjs2.Subject();
    this.dragging = this._dragging.pipe((0, import_rxjs2.distinctUntilChanged)());
  }
  ...
  update() {
    ...
    import_rxjs2.animationFrameScheduler.schedule(() => this.updateStyles(this.handleDirection(position, this.trackMax), size));
  }
  /**
  ...
  dragged(event) {
    let trackMaxStart;
    let scrollMaxStart;
    const dragStart = (0, import_rxjs2.of)(event).pipe(preventSelection(this.document), (0, import_rxjs2.tap)(() => {
      trackMaxStart = this.trackMax;
      scrollMaxStart = this.viewportScrollMax;
      this.setDragging(true);
    }));
    const dragging = (0, import_rxjs2.fromEvent)(this.document, "mousemove", {
      capture: true,
      passive: true
    }).pipe(stopPropagation());
    const dragEnd = (0, import_rxjs2.fromEvent)(this.document, "mouseup", {
      capture: true
    }).pipe(stopPropagation(), enableSelection(this.document), (0, import_rxjs2.tap)(() => this.setDragging(false)));
    return dragStart.pipe((0, import_rxjs2.map)((e) => e[this.pageProperty]), (0, import_rxjs2.map)((pageOffset) => pageOffset - this.dragStartOffset), (0, import_rxjs2.mergeMap)((mouseDownOffset) => dragging.pipe(
      (0, import_rxjs2.map)((e) => e[this.clientProperty]),
      // Calculate how far the pointer is from the top/left of the scrollbar (minus the dragOffset).
      (0, import_rxjs2.map)((mouseOffset) => mouseOffset - this.track.offset),
      (0, import_rxjs2.map)((offset) => scrollMaxStart * (offset - mouseDownOffset) / trackMaxStart),
      (0, import_rxjs2.map)((position) => this.handleDrag(position, scrollMaxStart)),
      (0, import_rxjs2.tap)((position) => this.scrollTo(position)),
      (0, import_rxjs2.takeUntil)(dragEnd)
    )));
  }
};
...
var _Scrollbar = class _Scrollbar {
  constructor(el, cmp, platform, document, zone) {
    ...
    this.document = document;
    this.zone = zone;
    this.destroyed = new import_rxjs2.Subject();
  }
  /**
  ...
  activatePointerEvents() {
    ...
    if (this.cmp.pointerEventsMethod === "viewport") {
      this.viewportTrackClicked = new import_rxjs2.Subject();
      this.viewportThumbClicked = new import_rxjs2.Subject();
      ...
      trackHoveredEvent = this.cmp.viewport.hovered.pipe(
        ...
        (0, import_rxjs2.map)((e) => e ? isWithinBounds(e, this.el.getBoundingClientRect()) : false),
        (0, import_rxjs2.distinctUntilChanged)(),
        // Enable / disable text selection
        (0, import_rxjs2.tap)((hovered) => this.document.onselectstart = hovered ? () => false : null)
      );
      this.cmp.viewport.clicked.pipe((0, import_rxjs2.tap)((e) => {
        if (e) {
      ...
      }), (0, import_rxjs2.takeUntil)(this.destroyed)).subscribe();
    } else {
      thumbDragEvent = this.thumb.clicked;
      trackClickEvent = this.track.clicked;
      trackHoveredEvent = this.hovered;
    }
    return (0, import_rxjs2.merge)(
      // Activate scrollbar hovered event
      trackHoveredEvent.pipe((0, import_rxjs2.tap)((e) => this.setHovered(e))),
      // Activate scrollbar thumb drag event
      thumbDragEvent.pipe((0, import_rxjs2.switchMap)((e) => this.thumb.dragged(e))),
      // Activate scrollbar track click event
      trackClickEvent.pipe((0, import_rxjs2.switchMap)((e) => this.track.onTrackClicked(e, this.thumb.size, this.viewportScrollSize)))
    );
  }
  // Stream that emits when the track element is hovered
  get hovered() {
    const mouseEnter = (0, import_rxjs2.fromEvent)(this.el, "mouseenter", {
      passive: true
    }).pipe(stopPropagation(), (0, import_rxjs2.map)(() => true));
    const mouseLeave = (0, import_rxjs2.fromEvent)(this.el, "mouseleave", {
      passive: true
    }).pipe(stopPropagation(), (0, import_rxjs2.map)(() => false));
    return (0, import_rxjs2.merge)(mouseEnter, mouseLeave);
  }
  ngOnInit() {
    this.zone.runOutsideAngular(() => {
      if (!(this.platform.IOS || this.platform.ANDROID) && !this.cmp.pointerEventsDisabled) {
        this.activatePointerEvents().pipe((0, import_rxjs2.takeUntil)(this.destroyed)).subscribe();
      }
      (0, import_rxjs2.merge)(this.cmp.scrolled, this.cmp.updated).pipe((0, import_rxjs2.tap)(() => this.thumb?.update()), (0, import_rxjs2.takeUntil)(this.destroyed)).subscribe();
    });
  }
  ngOnDestroy() {
    this.destroyed.next();
...
var _NativeScrollbarSizeFactory = class _NativeScrollbarSizeFactory {
  constructor(document, manager, platform) {
    ...
    this.platform = platform;
    this._scrollbarSize = new import_rxjs2.BehaviorSubject(this.getNativeScrollbarSize());
    this.scrollbarSize = this._scrollbarSize.asObservable();
    if (platform.isBrowser) {
      (0, import_rxjs2.fromEvent)(this.document.defaultView, "resize", {
        passive: true
      }).pipe((0, import_rxjs2.debounceTime)(this.manager.globalOptions.windowResizeDebounce), (0, import_rxjs2.map)(() => this.getNativeScrollbarSize()), (0, import_rxjs2.distinctUntilChanged)(), (0, import_rxjs2.tap)((size) => this._scrollbarSize.next(size))).subscribe();
    }
  }
  /**
...
var _HideNativeScrollbar = class _HideNativeScrollbar {
  constructor(el, renderer, hideNativeScrollbar) {
    ...
    this._subscriber = import_rxjs2.Subscription.EMPTY;
...
var _ResizeSensor = class _ResizeSensor {
  ...
  _subscribe() {
    this._unsubscribe();
    if (this.platform.isBrowser) {
      const stream = new import_rxjs2.Observable((observer) => {
      ...
      this.zone.runOutsideAngular(() => {
        this._currentSubscription = (this._debounce ? stream.pipe((0, import_rxjs2.debounceTime)(this._debounce)) : stream).subscribe(this.event);
      });
    }
  }
  _unsubscribe() {
...
var _NgScrollbar = class _NgScrollbar {
  ...
  getScrolledByDirection(property) {
    let event;
    return this.scrolled.pipe((0, import_rxjs2.tap)((e) => event = e), (0, import_rxjs2.map)((e) => e.target[property]), (0, import_rxjs2.pairwise)(), (0, import_rxjs2.filter)(([prev, curr]) => prev !== curr), (0, import_rxjs2.map)(() => event));
  }
  /**
  ...
  ngOnInit() {
    this.zone.runOutsideAngular(() => {
      ...
      let scrollStream = (0, import_rxjs2.fromEvent)(this.viewport.nativeElement, "scroll", {
        passive: true
      });
      scrollStream = this.scrollAuditTime ? scrollStream.pipe((0, import_rxjs2.auditTime)(this.scrollAuditTime)) : scrollStream;
      this.scrolled = scrollStream.pipe((0, import_rxjs2.takeUntil)(this.destroyed));
  ...
  ngAfterViewInit() {
    this.update();
    this.dir.change.pipe((0, import_rxjs2.tap)(() => this.update()), (0, import_rxjs2.takeUntil)(this.destroyed)).subscribe();
  }
  ngOnDestroy() {
    this.destroyed.next();
    this.destroyed.complete();
