...
var StripeInstance = class {
  ...
  key;
  options;
  stripe$ = new import_rxjs.BehaviorSubject(void 0);
  stripe = this.stripe$.asObservable().pipe((0, import_operators.filter)((stripe) => Boolean(stripe)));
  constructor(version, loader, window2, key, options) {
    ...
    this.loader.asStream().pipe((0, import_operators.filter)((status) => status.loaded === true), (0, import_operators.first)(), (0, import_operators.map)(() => this.window.getNativeWindow().Stripe)).subscribe((stripeInstance) => {
  ...
  elements(options) {
    return this.stripe.pipe((0, import_operators.map)((stripe) => stripe.elements(options)), (0, import_operators.first)());
  }
  redirectToCheckout(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.redirectToCheckout(options))), (0, import_operators.first)());
  }
  confirmPayment(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPayment(options))), (0, import_operators.first)());
  }
  confirmAcssDebitPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAcssDebitPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmUsBankAccountPayment(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmUsBankAccountPayment(clientSecret, data))), (0, import_operators.first)());
  }
  confirmAlipayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAlipayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmAuBecsDebitPayment(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAuBecsDebitPayment(clientSecret, data))), (0, import_operators.first)());
  }
  confirmBancontactPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmBancontactPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmBlikPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmBlikPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmBoletoPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmBoletoPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmCardPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmCardPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmCashappPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmCashappPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmCustomerBalancePayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmCustomerBalancePayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmEpsPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmEpsPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmFpxPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmFpxPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmGiropayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmGiropayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmGrabPayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmGrabPayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmIdealPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmIdealPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmKlarnaPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmKlarnaPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmKonbiniPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmKonbiniPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmMobilepayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmMobilepayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmOxxoPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmOxxoPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmP24Payment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmP24Payment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmPayNowPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPayNowPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmPayPalPayment(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPayPalPayment(clientSecret, data))), (0, import_operators.first)());
  }
  confirmPixPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPixPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmPromptPayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPromptPayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmSepaDebitPayment(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmSepaDebitPayment(clientSecret, data))), (0, import_operators.first)());
  }
  confirmSofortPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmSofortPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmWechatPayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmWechatPayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  handleCardAction(clientSecret) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.handleCardAction(clientSecret))), (0, import_operators.first)());
  }
  handleNextAction(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.handleNextAction(options))), (0, import_operators.first)());
  }
  verifyMicrodepositsForPayment(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.verifyMicrodepositsForPayment(clientSecret, data))), (0, import_operators.first)());
  }
  createRadarSession() {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.createRadarSession())), (0, import_operators.first)());
  }
  collectBankAccountForPayment(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.collectBankAccountForPayment(options))), (0, import_operators.first)());
  }
  createPaymentMethod(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.createPaymentMethod(options))), (0, import_operators.first)());
  }
  createConfirmationToken(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.createConfirmationToken(options))), (0, import_operators.first)());
  }
  retrievePaymentIntent(clientSecret) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.retrievePaymentIntent(clientSecret))), (0, import_operators.first)());
  }
  confirmSetup(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmSetup(options))), (0, import_operators.first)());
  }
  confirmAcssDebitSetup(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAcssDebitSetup(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmUsBankAccountSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmUsBankAccountSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmAuBecsDebitSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAuBecsDebitSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmBacsDebitSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmBacsDebitSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmBancontactSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmBancontactSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmCardSetup(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmCardSetup(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmCashappSetup(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmCashappSetup(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmIdealSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmIdealSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmPayPalSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPayPalSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmSepaDebitSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmSepaDebitSetup(clientSecret, data))), (0, import_operators.first)());
  }
  confirmSofortSetup(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmSofortSetup(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmAffirmPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAffirmPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  confirmAfterpayClearpayPayment(clientSecret, data, options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmAfterpayClearpayPayment(clientSecret, data, options))), (0, import_operators.first)());
  }
  verifyMicrodepositsForSetup(clientSecret, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.verifyMicrodepositsForSetup(clientSecret, data))), (0, import_operators.first)());
  }
  collectBankAccountForSetup(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.collectBankAccountForSetup(options))), (0, import_operators.first)());
  }
  retrieveSetupIntent(clientSecret) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.retrieveSetupIntent(clientSecret))), (0, import_operators.first)());
  }
  processOrder(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.processOrder(options))), (0, import_operators.first)());
  }
  retrieveOrder(clientSecret) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.retrieveOrder(clientSecret))), (0, import_operators.first)());
  }
  ...
  createToken(tokenType, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.createToken(tokenType, data))), (0, import_operators.first)());
  }
  createSource(a, b) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.createSource(a, b))), (0, import_operators.first)());
  }
  retrieveSource(source) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.retrieveSource(source))), (0, import_operators.first)());
  }
  verifyIdentity(clientSecret) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.verifyIdentity(clientSecret))), (0, import_operators.first)());
  }
  collectFinancialConnectionsAccounts(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.collectFinancialConnectionsAccounts(options))), (0, import_operators.first)());
  }
  collectBankAccountToken(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.collectBankAccountToken(options))), (0, import_operators.first)());
  }
  createEphemeralKeyNonce(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.createEphemeralKeyNonce(options))), (0, import_operators.first)());
  }
  initCustomCheckout(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.initCustomCheckout(options))), (0, import_operators.first)());
  }
  initEmbeddedCheckout(options) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.initEmbeddedCheckout(options))), (0, import_operators.first)());
  }
  /**
   * @deprecated
   */
  handleCardPayment(clientSecret, element, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.handleCardPayment(clientSecret, element, data))), (0, import_operators.first)());
  }
  /**
   * @deprecated
   */
  confirmPaymentIntent(clientSecret, element, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmPaymentIntent(clientSecret, element, data))), (0, import_operators.first)());
  }
  /**
   * @deprecated
   */
  handleCardSetup(clientSecret, element, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.handleCardSetup(clientSecret, element, data))), (0, import_operators.first)());
  }
  /**
   * @deprecated
   */
  confirmSetupIntent(clientSecret, element, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.confirmSetupIntent(clientSecret, element, data))), (0, import_operators.first)());
  }
  /**
   * @deprecated
   */
  handleFpxPayment(clientSecret, element, data) {
    return this.stripe.pipe((0, import_operators.switchMap)((stripe) => (0, import_rxjs.from)(stripe.handleFpxPayment(clientSecret, element, data))), (0, import_operators.first)());
  }
...
var LazyStripeAPILoader = class _LazyStripeAPILoader {
  ...
  window;
  document;
  status = new import_rxjs.BehaviorSubject({
    error: false,
    loaded: false,
    loading: false
  });
...
var StripeService = class _StripeService {
  ...
  getStripeReference() {
    return this.loader.asStream().pipe((0, import_operators.filter)((status) => status.loaded === true), (0, import_operators.map)(() => this.window.getNativeWindow().Stripe));
  }
  getInstance() {
...
var StripeElementsDirective = class _StripeElementsDirective {
  ...
  fetchUpdates() {
    ...
    return (0, import_rxjs.from)(this._elements.fetchUpdates());
  }
  update(options) {
    if (!this._elements) return null;
  ...
  submit() {
    if (!this._elements) return null;
    return (0, import_rxjs.from)(this._elements.submit());
  }
...
var StripePaymentElementComponent = class _StripePaymentElementComponent {
  ...
  fetchUpdates() {
    return (0, import_rxjs.from)(this.elements.fetchUpdates());
  }
  createElement(options = {}) {
    if (this.element) {
      this.element.unmount();
...
var StripePaymentRequestButtonComponent = class _StripePaymentRequestButtonComponent {
  ...
  canMakePayment() {
    return (0, import_rxjs.from)(this.paymentRequest.canMakePayment());
  }
  update(options) {
    this.element.update(options);
  }
