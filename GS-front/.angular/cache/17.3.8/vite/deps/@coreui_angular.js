...
function AvatarComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, AvatarComponent_ng_template_3_Conditional_0_Template, 1, 2, "img", 3)(1, AvatarComponent_ng_template_3_Conditional_1_Template, 1, 0);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
_AvatarComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 5,
  vars: 2,
  consts: [["defaultImageTemplate", ""], [4, "ngTemplateOutlet"], [3, "ngClass"], ["fill", "", 1, "avatar-img", 3, "ngSrc", "alt"]],
  ...
  dependencies: [NgTemplateOutlet, NgClass, NgOptimizedImage],
  encapsulation: 2
});
...
var _DropdownToggleDirective = class _DropdownToggleDirective {
  constructor() {
    ...
    __privateAdd(this, _dropdownService2, void 0);
    __privateAdd(this, _ariaExpanded, void 0);
...
_TabsComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    activeItemKey: [InputFlags.SignalBased, "activeItemKey"],
...
var _TabDirective = class _TabDirective {
  constructor() {
    ...
    __privateAdd(this, _elementRef4, void 0);
    __privateAdd(this, _tabsService, void 0);
...
_TabDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    disabled: [InputFlags.HasDecoratorInputTransform, "disabled", "disabled", booleanAttribute],
    itemKey: [InputFlags.SignalBased, "itemKey"],
    id: [InputFlags.SignalBased, "id"],
    ariaControls: [InputFlags.SignalBased, "aria-controls", "ariaControls"]
  },
  exportAs: ["cTab"],
  standalone: true,
  features: [ɵɵInputTransformsFeature]
...
var _TabsListComponent = class _TabsListComponent {
  constructor() {
    __privateAdd(this, _destroyRef10, void 0);
    __privateAdd(this, _focusKeyManager2, void 0);
...
_TabsListComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    layout: [InputFlags.SignalBased, "layout"],
    variant: [InputFlags.SignalBased, "variant"],
    role: [InputFlags.SignalBased, "role"]
  },
  exportAs: ["cTabsList"],
  standalone: true,
  features: [ɵɵStandaloneFeature],
...
_TabPanelComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    ...
    id: [InputFlags.SignalBased, "id"],
    itemKey: [InputFlags.SignalBased, "itemKey"],
    tabindex: [InputFlags.SignalBased, "tabindex"],
    transition: [InputFlags.SignalBased, "transition"]
  },
  outputs: {
    visibleChange: "visibleChange"
  },
...
var _ToasterComponent = class _ToasterComponent {
  constructor(hostElement, renderer, toasterService) {
    __privateAdd(this, _destroyRef11, void 0);
    this.hostElement = hostElement;
    this.renderer = renderer;
    this.toasterService = toasterService;
...
var _TooltipDirective = class _TooltipDirective {
  constructor(document2, renderer, hostElement, viewContainerRef, listenersService, changeDetectorRef, intersectionService) {
    __privateAdd(this, _destroyRef12, void 0);
    this.document = document2;
    this.renderer = renderer;
    this.hostElement = hostElement;
    this.viewContainerRef = viewContainerRef;
...
_TooltipDirective.ɵdir = ɵɵdefineDirective({
  ...
  inputs: {
    content: [InputFlags.SignalBased, "cTooltip", "content"],
    popperOptions: [InputFlags.SignalBased, "cTooltipOptions", "popperOptions"],
    placement: [InputFlags.SignalBased, "cTooltipPlacement", "placement"],
    reference: [InputFlags.SignalBased, "cTooltipRef", "reference"],
    trigger: [InputFlags.SignalBased, "cTooltipTrigger", "trigger"],
    visible: [InputFlags.SignalBased, "cTooltipVisible", "visible"]
  },
  outputs: {
