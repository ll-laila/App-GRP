...
_ChartjsComponent.ɵfac = function ChartjsComponent_Factory(t) {
  return new (t || _ChartjsComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ChangeDetectorRef));
};
_ChartjsComponent.ɵcmp = ɵɵdefineComponent({
  ...
  inputs: {
    customTooltips: [InputFlags.HasDecoratorInputTransform, "customTooltips", "customTooltips", booleanAttribute],
    data: "data",
    height: [InputFlags.HasDecoratorInputTransform, "height", "height", (value) => numberAttribute(value, void 0)],
    id: "id",
    options: "options",
    plugins: "plugins",
    redraw: [InputFlags.HasDecoratorInputTransform, "redraw", "redraw", booleanAttribute],
    type: "type",
    width: [InputFlags.HasDecoratorInputTransform, "width", "width", (value) => numberAttribute(value, void 0)],
    wrapper: [InputFlags.HasDecoratorInputTransform, "wrapper", "wrapper", booleanAttribute]
  },
  outputs: {
...
_ChartjsModule.ɵfac = function ChartjsModule_Factory(t) {
  return new (t || _ChartjsModule)();
};
